...
/// Formato 1, congelado. Nunca va a tener otra entrada.
///
/// El `0.1.0` que este crate llevó mientras se lo escribía no está: nombraba el
/// mismo formato con otro número y no se publicó nunca. La regla de sólo-agregar
/// protege lo que alguien pudo haber bajado, no los números que no salieron.
