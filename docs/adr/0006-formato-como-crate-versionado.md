...
**Parte de** **la épica del MVP**. Depende de [ADR-0003](0003-formato-captures-y-aceptacion.md), que decide **qué** es el formato; éste decide **dónde vive** y **cómo se versiona**.
