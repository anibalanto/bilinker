...
**Parte de** **la épica del MVP**. Usa el vocabulario de [ADR-0003](0003-formato-captures-y-aceptacion.md) —`accepted`, el `commit` derivado, `cache/state`— y es precondición de [ADR-0005](0005-frontera-entre-proyectos.md), porque lo que el consumidor trae del proveedor es exactamente esta ref.
