...
pub use bilink::{Accepted, AcceptedDimension, BiLink, CaptureSet, DeclaredDimension, DeclaredLevel, DeclaredN, DeclinedMark, LevelLink, LEVEL_LINK_UNKNOWN, Endpoint, Endpoints, Neighbourhood, N};
